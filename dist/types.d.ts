...
export interface SchedulerProps {
    ...
    /** */
    navigationPickerProps?: Partial<Omit<CalendarPickerProps<Date>, "open" | "onClose" | "openTo" | "views" | "value" | "readOnly" | "onChange" | "renderInput">>;
    /**Events to display */
     ...
     */
    onEventDrop?(droppedOn: Date, updatedEvent: ProcessedEvent, originalEvent: ProcessedEvent): Promise<ProcessedEvent | void>;
    /**
     *
     */
